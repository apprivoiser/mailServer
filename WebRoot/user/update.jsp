...
<body>
    ...
    <li><label>用户名</label><input name="uname" type="text" value="<%=uname %>" class="dfinput" /><i>用户名是邮箱地址</i></li>
    <li><label>密码</label><input name="pwd" type="text" value="<%=pwd %>" class="dfinput" /><i>字母加数字，不超过20个字符</i></li>
